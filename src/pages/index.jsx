...
const features = [
  {
    ...
    description: `Content is powered by MDX and lives alongside the codebase. It's built to be opionated when you're lazy, but infinately flexible when you need it to be.`,
    cta: {
  ...
  },
  {
    ...
    description:
      'The platform is meticulously designed and implemented to bring users to where they need to be. Everything is also optimized for a great user experience, from performance to navigation.',
    cta: {
      name: 'View showcase',
      href: '/showcase',
    },
