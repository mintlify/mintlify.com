...
export default function Loading() {
  ...
  return (
    <>
      <Head>
        <title>Loading...</title>
        <meta name="description" content="Building your docs..." />
      </Head>
      <SimpleLayout
        title="Building your docs..."
        intro="This should take just a few seconds. Please do not refresh the page"
      >
        <div className="relative flex h-56 w-full justify-center">
          <svg
            aria-hidden="true"
            className="h-8 w-8 animate-spin fill-green-600 text-zinc-200 dark:text-zinc-600"
            viewBox="0 0 100 101"
            fill="none"
