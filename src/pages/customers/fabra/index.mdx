...
export const meta = {
  title:
    'A solution in minutes—How Fabra worked with Mintlify to launch their API documentation with speed and efficiency',
  description:
  ...
  quote:
    'With Mintlify, it was super easy to get started and we basically had 90% of what we wanted in just a few minutes.',
  person: 'Nick Fiacco',
  role: 'Co-Founder',
}

export const about = {
  imageUrl: '/static/images/customers/resend/about.webp',
  url: 'https://fabra.io',
  description:
...
As the founder and CEO of Resend, [Zeno Rocha](https://www.linkedin.com/in/zenorocha/) is driven to build the best developer-focused email API and create high-quality documentation for it.
...
So in November of 2022, they tried Mintlify, hopeful that fellow YC alumni (W22) could deliver on design and performance. Impressed by what they saw, Resend also chose Mintlify for its open source project, [React Email](https://react.email/).
...
Resend easily customized the templates, creating a seamless fit between its website and [docs](https://resend.com/docs/introduction), both featuring the same simple, black and white aesthetic.
