...
export const meta = {
  ...
  quote:
    "Without Mintlify, our products wouldn’t be at the level they are now. I doubt we'd have this many users in such a short amount of time if we had to build our own docs.",
  person: 'Zeno Rocha',
  role: 'Founder & CEO',
}
