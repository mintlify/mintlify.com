...
[Join us or sign in now](https://mintlify.com/start?utm_campaign=how-to-openapi&utm_medium=blog&utm_source=mintlify) now to autogenerate your API docs with Mintlify. For support or feedback, find us on [Twitter](https://twitter.com/mintlify) or join our [Slack community](https://mintlify.com/community) to stay posted.
