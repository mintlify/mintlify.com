...
export const meta = {
  ...
  mobileImageUrl: '/static/images/blog/launch-week-day-3/thumbnail.svg',
...
To see your changes in production, we're launching Global CSS in beta with our new [Growth plan](mintlify.com/pricing). As a thank you for being an early user, we're offering a **15% discount** for the next year as we release some exciting features in the upcoming month.
