...
export const meta = {
  ...
  mobileImageUrl: '/static/images/blog/autogenerate-openapi/desktop.png',
...
[OpenAPI](https://www.openapis.org/) is a standardized format for describing and documenting RESTful APIs, setting
