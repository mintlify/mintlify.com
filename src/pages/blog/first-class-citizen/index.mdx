...
export const meta = {
  ...
  description:
    'Documentation is the product. A well-crafted documentation is like a well-told story - it should be easy to follow, understand, and apply. ',
  imageUrl: '/static/images/blog/first-class-citizen/mintlify-graphic.svg',
  author: 'One Chowdhury',
  authorRole: 'Engineering',
  date: 'May 19, 2023',
  category: 'About',
  authorImageUrl: '/static/images/blog/authors/one.png',
}

export default (props) => <ArticleLayout meta={meta} {...props} />

<img
  src="/static/images/blog/first-class-citizen/mintlify-graphic.svg"
  alt="blog thumbnail"
