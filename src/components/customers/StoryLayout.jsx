      ...
      <Container className="mt-16 lg:mt-24">
        <div className="relative">
          <div className="grid-cols mx-auto grid grid-cols-8 items-start">
            <Link
              className="b-8 group col-span-1 mt-12 hidden lg:flex items-center justify-start space-x-0.5 text-left text-sm font-medium text-zinc-600 transition hover:text-zinc-900 dark:text-zinc-500 dark:hover:text-zinc-300 lg:-left-5 lg:mb-0 xl:-top-0.5 xl:left-0 xl:mt-0"
              href="/customers"
            >
              <ArrowLeftIcon className="h-5 w-5" />
              <span>Back</span>
            </Link>
            <article className="col-span-8 lg:col-span-6">
              ...
              <div className="grid-cols mt-6 grid grid-cols-6 gap-12">
                <div className="lg:sticky top-0 col-span-6 lg:col-span-2 max-h-screen pr-4 pt-12">
                  <img
                    src={about.imageUrl}
                ...
                <Prose className="col-span-6 lg:col-span-4 mt-4">{children}</Prose>
              </div>
            </article>
          </div>
        </div>
