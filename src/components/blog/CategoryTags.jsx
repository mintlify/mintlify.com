  ...
  return (
    <div
      className={clsx(
        ...
        isSelected ? 'border-green-700 text-green-800 dark:border-green-400/50 dark:text-green-300/90' : 'border-zinc-200 dark:border-zinc-700 dark:hover:border-zinc-500'
      )}
      onClick={onClick}
    >
      {title}
